      ...
      <div className="container-wide">
        ...
        <div className="space-y-5">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-5 items-stretch">
            <Link
              href={`/${locale}/media-center/${firstRow.featured.slug}`}
            ...
            >
                ...
                <div className="absolute top-5 start-5">
                  <span className="bg-secondary-500 text-white text-xs font-bold px-3 py-1.5 rounded-md">
                    {categoryLabels[firstRow.featured.category]?.[locale] ?? firstRow.featured.category}
                  </span>
                </div>
                ...
                <div className="relative z-10 mt-auto p-7">
                  <div className="flex items-center gap-2 text-white/50 text-xs mb-3">
                    ...
                    <time dateTime={firstRow.featured.date}>{formatDate(firstRow.featured.date, locale)}</time>
                    {firstRow.featured.author && <><span>·</span><span>{firstRow.featured.author[locale]}</span></>}
                  </div>
                  ...
                  <p className="hidden lg:block text-white/70 text-sm leading-relaxed mb-5 line-clamp-2">
                    {firstRow.featured.excerpt[locale]}
                  </p>
