  ...
  return (
    ...
    >
      <div className="relative aspect-video overflow-hidden bg-neutral-800">
        <Image src={item.image} alt={item.title[locale as Locale]} fill className="object-cover group-hover:scale-105 transition-transform duration-500" sizes="(max-width:768px) 100vw, 400px" />
            ...
            <div>
              ...
              <Link href={`/${locale}/media-center/${featured.slug}`}
                ...
                <div className="relative h-64 lg:h-full overflow-hidden">
                  <Image src={featured.image} alt={featured.title[locale as Locale]} fill className="object-cover group-hover:scale-105 transition-transform duration-500" sizes="700px" />
                ...
                <div key={item.id} className={`rounded-3xl overflow-hidden ${V.card}`}>
                  {item.embedType === 'youtube' ? (
                    ...
                    <div className="relative aspect-square overflow-hidden">
                      <Image src={item.image} alt={item.title[locale as Locale]} fill className="object-cover" sizes="500px" />
              ...
              {filtered.map(item => (
                <div key={item.id} className={`rounded-2xl p-5 flex gap-5 items-center transition-all ${V.card} ${V.cardHov}`}>
                  <div className="relative w-20 h-20 rounded-2xl overflow-hidden shrink-0">
                    <Image src={item.image} alt={item.title[locale as Locale]} fill className="object-cover" sizes="80px" />
                  </div>
