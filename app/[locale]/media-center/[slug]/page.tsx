                ...
                <div className="rounded-3xl overflow-hidden shadow-lg">
                  {item.embedType === 'youtube' ? (
                    ...
                    <div className="relative aspect-square overflow-hidden">
                      <Image src={item.image} alt={item.title[locale as Locale]} fill className="object-cover" sizes="600px" />
                    ...
                    {related.map(rel => (
                      <Link key={rel.id} href={`/${locale}/media-center/${rel.slug}`}
                        ...
                        <div className="relative w-16 h-16 rounded-xl overflow-hidden shrink-0">
                          <Image src={rel.image} alt={rel.title[locale as Locale]} fill className="object-cover" sizes="64px" />
                        </div>
                        <div>
